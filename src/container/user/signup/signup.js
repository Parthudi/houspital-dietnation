...
const SignUpUser = (props) => {
    ...
    const userFormData = () => {
        return ( <form  onSubmit={handleonSubmit}>
            ...
            <select className={classes.dropinput} name='role' value={role}  onChange={handleonchange('role')}  required >
                    <option value=''> Select Role </option>
                    <option value="user">User</option>
                    <option value="admin">Admin</option>
            </select>  
            <select className={classes.dropinput} name='gender' value={gender}  onChange={handleonchange('gender')}  required >
